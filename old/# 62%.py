...
train_datagen = ImageDataGenerator(
    ...
    rotation_range=20,           # ✅ realistis kamera sedikit miring
    width_shift_range=0.1,
    height_shift_range=0.1,
    shear_range=0.1,
    zoom_range=0.2,
    horizontal_flip=True,
    vertical_flip=False,         # ✅ tidak realistis untuk foto jalan
    brightness_range=[0.8, 1.2], # ✅ variasi cahaya wajar
    fill_mode='nearest'
)
...
base_model.trainable = False  # Semua layer frozen
