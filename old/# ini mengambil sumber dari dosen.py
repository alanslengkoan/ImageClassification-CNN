# ini mengambil sumber dari dosen
...
# ============================================================
# BUILD MODEL — FINE-TUNE 20 LAYER TERAKHIR
# ============================================================
base_model = ResNet50(
    weights='imagenet',
    include_top=False,
...
# ✅ Frozen semua kecuali 20 layer terakhir
...
# ============================================================
print('\n' + '=' * 60)
print('🚀 TRAINING — Fine-Tune 20 Layer Terakhir ResNet-50')
...
fig.suptitle('ResNet-50 Fine-Tuning — Klasifikasi Kerusakan Jalan\n(Fine-tune 20 Layer Terakhir, Input 160×160)',
...
plt.title('Confusion Matrix — ResNet-50 Fine-Tuning\nKlasifikasi Kerusakan Jalan',
...
with open(report_path, 'w') as f:
    f.write('Classification Report — ResNet-50 Fine-Tuning\n')
...
plt.title('ROC Curve — ResNet-50 Fine-Tuning\nKlasifikasi Kerusakan Jalan',
          fontsize=13, fontweight='bold')
...
plt.title('Precision-Recall Curve — ResNet-50 Fine-Tuning\nKlasifikasi Kerusakan Jalan',
          fontsize=13, fontweight='bold')
...
ax.set_title('Precision, Recall & F1-Score per Kelas\nResNet-50 Fine-Tuning — Klasifikasi Kerusakan Jalan',
             fontsize=13, fontweight='bold')
...
if best_val_acc >= 0.80:
    ...
    print('   → Pertimbangkan menambah data untuk hasil lebih baik')
else:
    print(f'\n⚠️  Belum mencapai 80% (saat ini {best_val_acc*100:.2f}%)')
    print('   → Solusi utama: tambah data per kelas minimal 300 gambar')