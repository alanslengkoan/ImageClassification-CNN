...
# ============================================================
# ✅ AUGMENTASI DIPERBAIKI
# Sedikit lebih agresif untuk data kecil
# ============================================================
train_datagen = ImageDataGenerator(
    preprocessing_function=preprocess_input,
    validation_split=VALIDATION_SPLIT,
    rotation_range=25,           # ✅ naik dari 20 → 25
    width_shift_range=0.15,      # ✅ naik dari 0.1 → 0.15
    height_shift_range=0.15,     # ✅ naik dari 0.1 → 0.15
    shear_range=0.15,            # ✅ naik dari 0.1 → 0.15
    zoom_range=0.25,             # ✅ naik dari 0.2 → 0.25
    horizontal_flip=True,
    vertical_flip=False,
    brightness_range=[0.75, 1.25], # ✅ sedikit diperlebar
    fill_mode='nearest'
)
...
# ============================================================
# ✅ BUILD MODEL — CLASSIFIER HEAD DIPERBAIKI
# Urutan: Dense → BN → Dropout (bukan BN dulu)
# Tambah 1 Dense layer (512 → 256)
# ============================================================
base_model = ResNet50(
    weights='imagenet',
    include_top=False,
...
print(f'   Trainable (aktif) : {trainable:,}  ← classifier head')
print(f'   Frozen (dikunci)  : {frozen:,}  ← ResNet-50 base')
...
# ============================================================
# ✅ CALLBACKS DIPERBAIKI
# monitor EarlyStopping → val_loss (lebih stabil)
# ============================================================
callbacks = [
    EarlyStopping(
        monitor='val_loss',        # ✅ diubah dari val_accuracy → val_loss
        patience=10,
    ...
    ModelCheckpoint(
        ...
        monitor='val_accuracy',    # simpan model dengan val_accuracy terbaik
        save_best_only=True,
        verbose=1
    ),
    ReduceLROnPlateau(
...
if best_val_acc >= 0.80:
    ...
    print('   → Share hasil & grafik untuk analisis lebih lanjut')