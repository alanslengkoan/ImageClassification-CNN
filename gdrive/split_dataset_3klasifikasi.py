...
# ============================================================
SOURCE_DIR = '/content/drive/MyDrive/dataset_all'        # sama dengan 4 kelas
...
CLASSES     = ['sedang', 'ringan', 'berat']   # ✅ hanya 3 kelas (tanpa baik)
...
# ============================================================
print('\n🗑️  Menghapus folder dataset_3class lama...')
...
print(f'\n{"=" * 50}')
print(f'🎉 Dataset 3 Kelas berhasil dibagi!')
...
print(f'   MyDrive/dataset_3class/')
print(f'   ├── train/')
for cls in CLASSES:
    print(f'   │   ├── {cls}/')
print(f'   ├── val/')
...
for cls in CLASSES:
    print(f'       ├── {cls}/')
print(f'\n➡️  Siap untuk training! Jalankan resnet50_3class.py')