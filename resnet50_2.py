...
BATCH_SIZE       = 32
EPOCHS           = 100
LEARNING_RATE    = 2e-4          # ✅ kembali ke 2e-4 (terbukti lebih baik)
NUM_CLASSES      = 3             # ✅ 3 kelas: baik, menengah, berat
FINE_TUNE_LAYERS = 12            # ✅ 12 layer terakhir
...
fig.suptitle('ResNet50 Fine-Tuning — Klasifikasi Kerusakan Jalan (3 Kelas)\n'
             '(Fine-tune 12 Layer, Input 224×224, Batch 32, LR 1e-4)',
...
plt.title('Precision-Recall Curve — ResNet50 (3 Kelas)\nKlasifikasi Kerusakan Jalan',
          fontsize=13, fontweight='bold')
...
# ============================================================
print('\n' + '=' * 60)
print('📋 RINGKASAN HASIL — ResNet50 3 Kelas (LINUX)')
print('=' * 60)
print(f'   Backbone          : ResNet50 pretrained ImageNet')
print(f'   📌 Strategi       : Gabung ringan+sedang → menengah')
