...
# ============================================================
# KONFIGURASI PATH — LOKAL (WINDOWS)
# ============================================================
...
LEARNING_RATE    = 2e-4         # Terbukti pada val 80.86%
NUM_CLASSES      = 3            # 3 kelas: baik, sedang, berat
FINE_TUNE_LAYERS = 20           # Lebih banyak layer backbone adapt
...
x       = base_model(inputs, training=False)  # BN pakai stats pre-trained (stabil)
...
# ============================================================
print('\n' + '=' * 60)
print('🚀 TRAINING ResNet50 — TWO-STAGE FINE-TUNING (LOKAL)')
print(f'   📌 Strategi  : Gabung ringan+sedang → sedang')
...
# Unfreeze last FINE_TUNE_LAYERS untuk Stage 2
...
ax.set_title('Precision, Recall & F1-Score per Kelas\nResNet50 Fine-Tuning — Klasifikasi Kerusakan Jalan (3 KELAS)',
             fontsize=13, fontweight='bold')
...
# ============================================================
print('\n' + '=' * 60)
print('📋 RINGKASAN HASIL — ResNet50 Fine-Tuning 3 KELAS (LOKAL)')
print('=' * 60)
print(f'   Backbone          : ResNet50 pretrained ImageNet')
print(f'   📌 Strategi       : Gabung ringan+sedang → sedang')
...
print(f'   Test Loss         : {test_loss:.4f}')
print(f'   Epoch berjalan    : {total_epochs} / {EPOCHS + WARMUP_EPOCHS}')
