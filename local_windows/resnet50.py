...
# ============================================================
TRAIN_DIR  = r'C:\dataset\train'    # ✅ ganti sesuai lokasi kamu
VAL_DIR    = r'C:\dataset\val'
TEST_DIR   = r'C:\dataset\test'
OUTPUT_DIR = r'C:\dataset\output'
...
# ============================================================
print('\n' + '=' * 60)
print('🚀 TRAINING ResNet50 — Fine-Tune + Class Weight (LOKAL)')
...
# ============================================================
print('\n' + '=' * 60)
print('📋 RINGKASAN HASIL — ResNet50 Fine-Tuning (LOKAL)')
print('=' * 60)
print(f'   Backbone          : ResNet50 pretrained ImageNet')
